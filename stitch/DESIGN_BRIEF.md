...
- VectorDrift Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called VectorDrift Lite. It should be a full-viewport arcade game where the player steers a glowing ship through shifting gates, avoids blockers, collects pulses, has a settings overlay, score/level HUD, pause/resume, restart, keyboard and click controls, and must be playable loc…
...
- Gameplay - VectorDrift Lite
- Game Settings - VectorDrift Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - VectorDrift Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - VectorDrift Lite
